...
ActiveRecord::Schema[7.0].define(version: 20_230_428_050_118) do
  ...
  create_table 'movements', force: :cascade do |t|
    ...
    t.index %w[inventory_id tipo_movimiento], name: 'index_movements_on_inventory_and_tipo_movimiento'
